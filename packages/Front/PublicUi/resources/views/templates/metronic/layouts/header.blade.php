        ...
        <div class="header-content">
            <div class="header-left">
                ...
                <a href="/" class="header-logo">
                    <img src="/templates/front/images/logo.png" alt="logo">
                </a>
                <a href="{{route('join')}}" class="header-widget header-user">
                    <img src="/templates/front/images/user.png" alt="user">
                    <span>join me</span>
                </a>
            ...
            <div class="header-right">
                        ...
                        <div class="dropdown-card">
                            ...
                            <ul class="message-list">
                                ...
                                <li class="message-item">
                                    <a href="message.html" class="message-link">
                                        <div class="message-img">
                                            <img src="/templates/front/images/user.png" alt="avatar">
                                        </div>
                                        <div class="message-text">
                ...
                @guest
                <a href="{{route('signin')}}" class="btn btn-inline post-btn">
                    <i class="fas fa-key"></i>
                    <span>Login</span>
                </a>
                <a href="{{route('join')}}" class="btn btn-inline post-btn">
                    <i class="fas fa-plus-circle"></i>
                    <span>Register Here</span>
                </a>
                @else
                    <a href="{{ route('logout') }}" class="btn btn-inline post-btn"   onclick="event.preventDefault();
