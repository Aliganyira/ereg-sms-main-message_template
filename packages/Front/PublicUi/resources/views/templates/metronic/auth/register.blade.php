...
<head>
    ...
    <base href="../../../">
    <title{{ config('app.name', 'Mabunu') }}</title>
    <meta charset="utf-8" />
    <link rel="shortcut icon" href="/images/favico-logo.png" />
    <!--begin::Fonts-->
            ...
            <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                ...
                <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
                    ...
                    <button type="button" class="btn btn-light-primary fw-bolder w-100 mb-10">
                        <img alt="Logo" src="templates/m/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Sign in with Google</button>
                    <!--end::Action-->
                    <!--begin::Separator-->
