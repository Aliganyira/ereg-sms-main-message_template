        ...
        <div class="navbar navbar-light bg-light navbar-expand-lg py-lg-2">
            ...
            <div class="navbar-collapse text-center text-lg-left flex-wrap collapse"
                ...
                <div class="navbar-text ml-lg-auto"><span class="font-weight-semibold">1-50</span> of
                    <span class="font-weight-semibold">528</span></div>
        ...
        <table class="table table-inbox">
            ...
            <tr class="unread">
                ...
                <td class="table-inbox-image">
                    <img src="/templates/l/global_assets/images/brands/spotify.png"
            ...
            <tr class="unread">
                ...
                <td class="table-inbox-message">
                    <div class="table-inbox-subject"><span class="badge bg-success mr-2">Promo</span>
            ...
            <tr class="unread">
                ...
                <td class="table-inbox-message">
                    <div class="table-inbox-subject">Any time these ten years, they tell me, has that
                        man held up &nbsp;-&nbsp;
                    </div>
            ...
            <tr>
                ...
                <td class="table-inbox-message">
                    <div class="table-inbox-subject">Throughout the Pacific, and also in Nantucket, and
                        New Bedford &nbsp;-&nbsp;
                    </div>
            ...
            <tr>
                ...
                <td class="table-inbox-image">
                    <img src="/templates/l/global_assets/images/brands/dribbble.png"
                         class="rounded-circle" width="32" height="32" alt="">
                </td>
                <td class="table-inbox-name">
                    <a href="mail_read.html">
            ...
            <tr>
                ...
                <td class="table-inbox-image">
                    <img src="/templates/l/global_assets/images/brands/twitter.png"
                         class="rounded-circle" width="32" height="32" alt="">
                </td>
                <td class="table-inbox-name">
                    <a href="mail_read.html">
                ...
                <td class="table-inbox-message">
                    <div class="table-inbox-subject"><span class="badge bg-indigo-400 mr-2">Order</span>
                        Long exile from Christendom &nbsp;-&nbsp;
                    </div>
            ...
            <tr>
                ...
                <td class="table-inbox-message">
                    <div class="table-inbox-subject">Your true whale-hunter is as much a savage as an
                        Iroquois &nbsp;-&nbsp;
                    </div>
            ...
            <tr>
                ...
                <td class="table-inbox-image">
                    <img src="/templates/l/global_assets/images/brands/facebook.png"
                         class="rounded-circle" width="32" height="32" alt="">
                </td>
                <td class="table-inbox-name">
                    <a href="mail_read.html">
            ...
            <tr>
                ...
                <td class="table-inbox-message">
                    <div class="table-inbox-subject"><span class="badge bg-pink-400 mr-2">Track</span>
                        Achilles's shield &nbsp;-&nbsp;
                    </div>
            ...
            <tr>
                ...
                <td class="table-inbox-image">
                    <img src="/templates/l/global_assets/images/brands/youtube.png"
                         class="rounded-circle" width="32" height="32" alt="">
                </td>
                <td class="table-inbox-name">
                    <a href="mail_read.html">
            ...
            <tr>
                ...
                <td class="table-inbox-image">
                    <img src="/templates/l/global_assets/images/brands/amazon.png"
                         class="rounded-circle" width="32" height="32" alt="">
                </td>
                <td class="table-inbox-name">
                    <a href="mail_read.html">
