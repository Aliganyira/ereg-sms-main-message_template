@php $base_path='/templates/d'; @endphp
    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Appraisals</h3>
                    ...
                    <div class="nk-tb-list nk-tb-ulist">
                            ...
                            <div class="nk-tb-col">
                                <div class="user-card">
                                    <div class="user-avatar">
                                        <img src="{{$base_path}}/images/avatar/a-sm.jpg" alt="">
                                    </div>
                                    <div class="user-info">
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col">
                                <div class="user-card">
                                    <div class="user-avatar">
                                        <img src="{{$base_path}}/images/avatar/b-sm.jpg" alt="">
                                    </div>
                                    <div class="user-info">
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col">
                                <div class="user-card">
                                    <div class="user-avatar">
                                        <img src="{{$base_path}}/images/avatar/c-sm.jpg" alt="">
                                    </div>
                                    <div class="user-info">
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col">
                                <div class="user-card">
                                    <div class="user-avatar">
                                        <img src="{{$base_path}}/images/avatar/d-sm.jpg" alt="">
                                    </div>
                                    <div class="user-info">
