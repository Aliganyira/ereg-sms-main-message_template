                        ...
                        <div class="nk-kycfm-content">
                            ...
                            <div class="nk-kycfm-upload">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-4 d-none d-sm-block">
                                        <div class="mx-md-4">
                                            <img src="{{$base_path}}/images/icons/id-front.svg" alt="ID Front">
                                        </div>
                                    </div>
                                </div>
                            </div><!-- nk-kycfm-upload -->
                            <div class="nk-kycfm-upload">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-4 d-none d-sm-block">
                                        <div class="mx-md-4">
                                            <img src="{{$base_path}}/images/icons/id-back.svg" alt="ID Back">
                                        </div>
                                    </div>
                                </div>
                            </div><!-- nk-kycfm-upload -->
                ...
                <div class="card-inner card-inner-lg">
                    <div class="nk-kyc-app p-sm-2 text-center">
                        ...
                        <div class="nk-kyc-app-action">
                            <a href="/{{Request::segment(1)}}/complete" class="btn btn-lg btn-primary">Click here to complete your KYC</a>
                        </div>
                    </div>
                </div>
            </div>
